...
export class AddTables1703243635515 implements MigrationInterface {
    ...
    public async up(queryRunner: PostgresQueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE IF NOT EXISTS "public"."USER" ("id" SERIAL PRIMARY KEY,
...
`);
await queryRunner.query(`CREATE TABLE IF NOT EXISTS "public"."PROVIDER_GROUP" (
...
`);
    ...
    public async down(queryRunner: PostgresQueryRunner): Promise<void> {
        ...
        await queryRunner.query('DROP TABLE IF EXISTS "public"."PROVIDER_GROUP"');
    }
